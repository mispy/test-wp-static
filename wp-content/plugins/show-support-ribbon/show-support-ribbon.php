...
/*
	...
	Tags: badge, banner, button, charity, event, fundraiser, link, non-profit, organization, rally, ribbon, support
	Author: Jeff Starr
...
&lt;/div&gt;</pre>
					...
					<div id="mm-panel-tertiary" class="postbox">
						<h2><?php _e('Customization Tips', 'ssr'); ?></h2>
						<div class="toggle<?php if (!isset($_GET["settings-updated"])) { echo ' default-hidden'; } ?>">
...
box-shadow:1px 1px 3px 0 rgba(0,0,0,0.3);</pre>
					...
					<div id="mm-restore-settings" class="postbox">
						<h2><?php _e('Restore Default Options', 'ssr'); ?></h2>
						<div class="toggle<?php if (!isset($_GET["settings-updated"])) { echo ' default-hidden'; } ?>">
							<p>
